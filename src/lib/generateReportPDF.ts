...
export async function generateReportPDF(reading: PalmReading, userData: UserData): Promise<void> {
  ...
  sans(10, 'bold');
  rgb(C.gold);
  doc.text('palmmitra.in/upgrade', W / 2, upsellY + 40, { align: 'center' });
  ...
  sans(10, 'bold');
  rgb(C.gold);
  doc.text('palmmitra.in', W / 2, shareY + 22, { align: 'center' });
  ...
  sans(10, 'bold');
  rgb(C.gold);
  doc.text('palmmitra.in/report', W / 2, revisitY + 10, { align: 'center' });
