...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    highlight: 'Best ₹299 I\'ve spent',
    text: "I was confused about my startup idea. PalmMitra's report gave me the clarity and confidence to actually pursue it. The wealth section said my financial peak window starts in 2025 — I'm going all in. Best ₹299 I've ever spent.",
    avatar: avatarRohit,
    verified: true,
    plan: 'Monthly Plan',
    date: 'Nov 2024',
