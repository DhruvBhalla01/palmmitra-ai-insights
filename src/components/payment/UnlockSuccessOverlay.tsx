...
import { Sparkles, Download, Share2, RefreshCw, Crown, Mail } from 'lucide-react';
      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            >
              {isSubscription ? (
                <>Premium Access<br /><span className="text-gradient-gold">Activated!</span></>
              ) : (
            ...
            >
              {isSubscription
                ? 'You now have premium access. Your spiritual journey awaits!'
            ...
            <motion.div
              ...
              className="flex items-center justify-center gap-2 text-sm text-accent mb-8"
            >
              <Mail className="w-4 h-4" />
              <span>Report will also be sent to your email</span>
            </motion.div>
            ...
            >
              ...
              <Button
                onClick={onDismiss}
                className={onDownloadPDF ? "rounded-xl px-6 py-3 gap-2 border-accent/30 hover:bg-accent/10" : "btn-gold rounded-xl px-6 py-3 gap-2"}
                variant={onDownloadPDF ? "outline" : "default"}
              >
              ...
              <Button
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({ title: 'PalmMitra Reading', text: 'Check out my palm reading!', url: window.location.href });
                  }
                }}
                variant="outline"
