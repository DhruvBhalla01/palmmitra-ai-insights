...
export function LoveRelationships({ emotionalStyle, commitmentTendency, relationshipAdvice }: LoveRelationshipsProps) {
  const items = [
    { icon: Heart, label: 'Emotional Style', value: emotionalStyle, color: 'text-pink-500', bg: 'bg-pink-500/10' },
    { icon: Users, label: 'Commitment Tendency', value: commitmentTendency, color: 'text-rose-500', bg: 'bg-rose-500/10' },
