...
export function CareerWealth({ bestFields, turningPointAge, wealthStyle, peakPeriods }: CareerWealthProps) {
  return (
    <motion.section
      ...
      <div className="glass rounded-2xl p-6 md:p-8 space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-foreground">Best Suited Fields</h3>
          </div>
        ...
        <div className="flex items-start gap-4 p-4 rounded-xl bg-primary/5 border border-primary/10">
          ...
          <div>
            <h3 className="font-semibold text-foreground mb-1">Career Turning Point</h3>
            <p className="text-sm text-muted-foreground">
              Ages <span className="font-semibold text-primary">{turningPointAge}</span> mark a significant shift in your professional trajectory.
            </p>
          </div>
        </div>
