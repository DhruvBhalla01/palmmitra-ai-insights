  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'PalmMitra Insight (single full reading) is ₹149 in India / $9.99 internationally. PalmMatch (couple compatibility reading) is ₹999 / $24.99. PalmMitra Elite (lifetime unlimited readings for the whole family with priority AI) is ₹4,999 / $149 — a one-time payment.',
      },
      {
